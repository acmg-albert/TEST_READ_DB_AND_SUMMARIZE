"""
Time on Market processor module.
Handles business logic for apartment time on market data.
"""

import logging
from typing import Dict, Any, List, Tuple
from ...database.apartmentlist.time_on_market_db import TimeOnMarketDBClient

# Configure logging
logger = logging.getLogger(__name__)

class TimeOnMarketProcessor:
    """Processor for time on market data."""
    
    def __init__(self):
        """Initialize processor with database client."""
        self.db_client = TimeOnMarketDBClient()
